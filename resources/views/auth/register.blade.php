    ...
    <x-guest-layout>
        <x-jet-authentication-card>
            ...
            <form class="w-full" method="POST" action="{{ route('register') }}">
                ...
                <x-jet-input id="usuario" class="w-full" type="text" name="usuario" :value="old('usuario')" required autofocus autocomplete="usuario" />

                <x-jet-label for="name" value="{{ __('Nombre') }}" style="color:white"/>
                ...
                <x-jet-label for="password_confirmation" value="{{ __('Confirmar contraseña') }}" style="color:white"/>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-2">
                                    {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                            'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="underline text-sm text-gray-600 hover:text-gray-300">'.__('Terms of Service').'</a>',
                                            'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="underline text-sm text-gray-600 hover:text-gray-300">'.__('Privacy Policy').'</a>',
                                    ]) !!}
                                </div>
                            </div>
                        </x-jet-label>
                ...
                <div class="flex items-center justify-end mt-4">
                    <a class="underline text-sm text-gray-600 hover:text-gray-300" href="{{ route('login') }}">
                        {{ __('Estas registrado?') }}
                    </a>
